'''
Unit test for churn libary module
...
def test_eda():
    ...
    dataframe = cls.import_data("./data/bank_data.csv")
    try:
        cls.perform_eda(eda_df=dataframe)
    ...
    try:
        ...
        logging.error('File %s not found', 'customer_age_distribution.png')
        raise err
    ...
    try:
        ...
        logging.error('File %s not found', 'marital_status_distribution.png')
        raise err
